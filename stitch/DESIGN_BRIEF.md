...
- OrbitTap Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called OrbitTap Lite. It should be a timing arcade game where the player launches a small orb between rotating rings, collects timed sparks, avoids moving hazards, pauses/resumes, opens settings/help, adjusts difficulty/audio, persists high score, and exposes testable runtime sta…
...
- Gameplay - OrbitTap Lite
- Game Settings - OrbitTap Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - OrbitTap Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - OrbitTap Lite
